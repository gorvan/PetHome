...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetHome.Shared.Core.Dtos.PetDto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHome.Shared.Core.Dtos.PhotoDto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHome.Shared.Core.Dtos.VolunteerDto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHome.Shared.Core.Dtos.PetDto", b =>
                {
                    b.HasOne("PetHome.Shared.Core.Dtos.VolunteerDto", null)
                        .WithMany("Pets")
            ...
            modelBuilder.Entity("PetHome.Shared.Core.Dtos.PhotoDto", b =>
                {
                    b.HasOne("PetHome.Shared.Core.Dtos.PetDto", null)
                        .WithMany("Photos")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
